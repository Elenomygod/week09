...
console.log('Нужно бежать со всех ног');
...
console.log('Добро ' + 'пожаловать,' + 'Елена');
...
console.log(strasint);
console.log(typeof (str));
console.log(typeof (strasint));